...
public class Dealer {
    public String dealerVisible;
    public String dealerHidden;
    ...
    public String showDealerCard(ArrayList finalDeck){
        this.dealerVisible = Card.drawRandomCard(finalDeck).toString();
